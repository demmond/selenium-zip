...
public class SeleniumZephyrInterceptor extends DefaultZBotScriptLauncher{

	private String outputPath = null;
	private String comments = null;
	private Logger logger = Logger.getLogger(SeleniumZephyrInterceptor.class.getName());
	...
	/**
	 * This method reads Zephyr server URL and user credentials from the properties file and use it for login.
	 */
	public SeleniumZephyrInterceptor() {
		super();
	 ...
	 * Assumptions
	 * 1. Expected format of Selenium testcase script path
	 *    <executable><testcase class><outputfolder>
	 * 		c:\automation\selenium\sample\seleniumRunner.bat AllTests c:\automation\selenium\sample
	 * 2. Result file should be of Testclass_result.txt
	 * <br/>
